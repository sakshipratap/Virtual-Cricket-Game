...
void Game::welcome()
{
    ...
    cout << "____________________________________________________" << endl;
    cout << "|                                                  |" << endl;
    cout << "| 1. Form two teams with 4 players each from       |" << endl;
    cout << "|    the given pool of 22 players.                 |" << endl;
    cout << "| 2. Lead the toss and decide the choice of play.  |" << endl;
    cout << "| 3. There will be 6 balls in each inning.         |" << endl;
...
void Game::showTeamPlayers()
{
    ...
    cout << endl << endl;
    cout << "__________________________\t\t _________________________" << endl;
